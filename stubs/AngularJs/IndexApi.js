(function ()
{
	...
	function apiService($resource)
	{
		...
		api.sampleUrl = 'app/data/' ;

		api.sample = $resource(api.sampleUrl + 'sample/sample.json');

		api.quickPanel = {
			activities: $resource(api.sampleUrl + 'quick-panel/activities.json'),
			contacts  : $resource(api.sampleUrl + 'quick-panel/contacts.json'),
			events    : $resource(api.sampleUrl + 'quick-panel/events.json'),
			notes     : $resource(api.sampleUrl + 'quick-panel/notes.json')
		};

		api.dashboard = {
			server   : $resource('app/data/dashboard/data_server.json'),
			project   : $resource('app/data/dashboard/data_project.json')
		};
